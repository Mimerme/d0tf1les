...
autocmd FileType go nunmap <buffer> <S-k>
nmap <S-j> :tabprevious <Enter>
nmap <S-k> :tabnext <Enter>
...
set shiftwidth=4
set expandtab
hi MatchParen cterm=bold ctermbg=233 ctermfg=208 gui=bold guifg=#FD971F guibg=#000000
